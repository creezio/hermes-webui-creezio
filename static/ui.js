...
function _showUpdateBanner(data){
  ...
  if(msg){
    ...
    lead.textContent='\u26A0\uFE0F Mise \u00e0 jour Hermes officielle disponible';
    msg.appendChild(lead);
    const detail=document.createElement('div');
    detail.style.marginTop='6px';
    detail.style.lineHeight='1.45';
    detail.textContent=parts.join(', ')+'. Ne pas appliquer depuis cette interface (fork Creezio). Demander une comparaison avec le repo officiel et fusionner via le skill hermes-upstream-sync-creezio.';
